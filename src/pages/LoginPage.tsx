...
import { Mail, Lock, ArrowRight, Send, ChevronLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-green-50 flex flex-col items-center justify-center px-6 py-10">
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-card border border-surface-border p-6">
        ...
        {mode === 'register' && (
          <>
            <h2 className="font-semibold text-ink text-lg mb-4">
              Create account
            </h2>
            <div className="flex flex-col gap-3">
              <Input
        ...
        {mode === 'magic-link' && (
          <>
            ...
            <p className="text-ink-muted text-sm mb-4">
              We'll send a one-tap sign-in link to your email. No password
              needed.
            </p>
            <div className="flex flex-col gap-3">
              <Input
        ...
        {mode === 'magic-sent' && (
          <div className="text-center py-4">
            ...
            <p className="text-xs text-ink-faint">
              Tap the link in the email to sign in instantly. You can close this
              tab.
            </p>
            <button
              onClick={() => setMode('magic-link')}
