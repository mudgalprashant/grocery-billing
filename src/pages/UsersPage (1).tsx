...
const roleBadge: Record<UserRole, 'red' | 'blue' | 'green' | 'gray'> = {
  admin: 'red',
  store: 'green',
  cashier: 'blue',
  customer: 'gray',
        ...
        {users?.map(u => (
          <Card key={u.uid}>
            <div className="flex items-center gap-3 mb-3">
              {u.photoURL
                ? <img src={u.photoURL} alt={u.displayName} className="w-10 h-10 rounded-full shrink-0" />
              ...
              <div className="flex-1 min-w-0">
                ...
                {u.storeId && <p className="text-xs text-ink-faint">Store: {u.storeId}</p>}
              </div>
