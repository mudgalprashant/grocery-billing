...
export function PendingApprovalsPage() {
  const { user } = useAuth()
  const { payments, loading, loadPending, approve, reject } = usePayments()
  ...
  return (
    <div className="px-4 py-5">
      ...
      <p className="text-sm text-ink-muted mb-4">Customer-submitted payments awaiting your review</p>
